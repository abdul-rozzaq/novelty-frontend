    ...
    <div className="flex justify-between">
      ...
      <div className="flex space-x-4">
        ...
        <div className="hidden md:flex items-center space-x-1">
          ...
          <Link href={'/dashboard'} className="py-5 px-3 text-gray-700 hover:text-gray-900">Dashboard</Link>
          <Link href={'/post'} className="py-5 px-3 text-gray-700 hover:text-gray-900">Posts</Link>
        </div>
      </div>
